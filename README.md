...
- **2026-04-28** [Optimizing ground state preparation protocols with autoresearch](https://arxiv.org/abs/2604.25610v1) (Autoresearch Loops) - card: [2604-25610v1-optimizing-ground-state-preparation-protocols-with-autoresearch.md](archive/papers/2026-04-30/2604-25610v1-optimizing-ground-state-preparation-protocols-with-autoresearch.md)
- **2026-04-27** [Dont Stop Early: Scalable Enterprise Deep Research with Controlled Information Flow and Evidence-Aware Termination](https://arxiv.org/abs/2604.24978v1) (Literature And Survey Agents) - card: [2604-24978v1-dont-stop-early-scalable-enterprise-deep-research-with-controlled-information-flow-and-evidence-aware-termination.md](archive/papers/2026-04-30/2604-24978v1-dont-stop-early-scalable-enterprise-deep-research-with-controlled-information-flow-and-evidence-aware-termination.md)
...
- [From Hypotheses to Factors: Constrained LLM Agents in Cryptocurrency Markets](https://arxiv.org/abs/2604.26747v1): This research demonstrates how constrained LLM agents can be effectively utilized for empirical discovery in high-stakes domains like cryptocurrency markets, ensuring reproducibility, transparency, and robust performance. It highlights the potential of combining AI-driven hypothesis generation with deterministic protocols to achieve actionable insights and measurable financial outcomes.
- [AutoResearchBench: Benchmarking AI Agents on Complex Scientific Literature Discovery](https://arxiv.org/abs/2604.25256v1): AutoResearchBench addresses a critical gap in evaluating AI agents for autonomous scientific discovery, a field with immense potential to accelerate research across disciplines. By focusing on complex literature discovery tasks, it challenges AI systems to go beyond general web browsing and engage in nuanced reasoning and comprehension, paving the way for more capable research assistants in the future.
...
- [Optimizing ground state preparation protocols with autoresearch](https://arxiv.org/abs/2604.25610v1): Ground-state preparation is a critical task in quantum computing and simulation, often requiring extensive manual tuning of protocols. By leveraging autoresearch and coding agents, researchers can automate this process, enabling faster and more efficient exploration of quantum systems while reducing human intervention. This approach has the potential to accelerate advancements in quantum technologies and computational physics.
<!-- END: featured-papers -->

## Latest Archive Entry

<!-- BEGIN: latest-entry -->
[HalluCiteChecker: A Lightweight Toolkit for Hallucinated Citation Detection and Verification in the Era of AI Scientists](https://arxiv.org/abs/2604.26835v1) is the latest archived addition. Themes: End-to-End AI Scientists. Why it matters: As AI tools increasingly assist in academic writing, the risk of hallucinated citations—references to non-existent works—has grown, threatening the integrity of scientific literature. HalluCiteChecker provides a practical solution to detect and verify citations, ensuring credibility and reducing the workload for reviewers and publishers in an era of AI-driven research workflows.
<!-- END: latest-entry -->
