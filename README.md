...
- **2026-03-30** [Towards a Medical AI Scientist](https://huggingface.co/papers/2603.28589) (End-to-End AI Scientists) - card: [2603-28589-towards-a-medical-ai-scientist.md](archive/papers/2026-03-31/2603-28589-towards-a-medical-ai-scientist.md)
- **2026-03-29** [MuSEAgent: A Multimodal Reasoning Agent with Stateful Experiences](https://huggingface.co/papers/2603.27813) (End-to-End AI Scientists) - card: [2603-27813-museagent-a-multimodal-reasoning-agent-with-stateful-experiences.md](archive/papers/2026-03-31/2603-27813-museagent-a-multimodal-reasoning-agent-with-stateful-experiences.md)
- **2026-03-28** [Agent-Driven Autonomous Reinforcement Learning Research: Iterative Policy Improvement for Quadruped Locomotion](https://arxiv.org/abs/2603.27416v1) (Autoresearch Loops) - card: [2603-27416v1-agent-driven-autonomous-reinforcement-learning-research-iterative-policy-improvement-for-quadruped-locomotion.md](archive/papers/2026-03-31/2603-27416v1-agent-driven-autonomous-reinforcement-learning-research-iterative-policy-improvement-for-quadruped-locomotion.md)
...
- [Marco DeepResearch: Unlocking Efficient Deep Research Agents via Verification-Centric Design](https://huggingface.co/papers/2603.28376): Marco DeepResearch tackles a critical bottleneck in autonomous research agents by integrating robust verification mechanisms, ensuring higher accuracy and reliability in solving complex, real-world problems. This innovation has the potential to redefine how AI systems approach open-ended investigations and long-horizon tasks, making them more dependable and scalable for practical applications across industries and academia.
- [MuSEAgent: A Multimodal Reasoning Agent with Stateful Experiences](https://huggingface.co/papers/2603.27813): MuSEAgent represents a significant advancement in AI research agents by enabling more nuanced decision-making through stateful experience modeling. This approach enhances the ability to synthesize information across textual and visual sources, paving the way for smarter, more adaptive AI systems capable of tackling complex reasoning tasks in diverse domains.
- [Agent-Driven Autonomous Reinforcement Learning Research: Iterative Policy Improvement for Quadruped Locomotion](https://arxiv.org/abs/2603.27416v1): This research demonstrates the potential of agent-driven systems to autonomously execute complex reinforcement learning tasks, reducing human workload while advancing robotics capabilities. It highlights how automation can streamline iterative experimentation in challenging domains like quadruped locomotion, paving the way for more scalable and efficient research methodologies in AI and robotics engineering.
...
<!-- BEGIN: latest-entry -->
[Marco DeepResearch: Unlocking Efficient Deep Research Agents via Verification-Centric Design](https://huggingface.co/papers/2603.28376) is the latest archived addition. Themes: End-to-End AI Scientists, Literature And Survey Agents. Why it matters: Marco DeepResearch tackles a critical bottleneck in autonomous research agents by integrating robust verification mechanisms, ensuring higher accuracy and reliability in solving complex, real-world problems. This innovation has the potential to redefine how AI systems approach open-ended investigations and long-horizon tasks, making them more dependable and scalable for practical applications across industries and academia.
<!-- END: latest-entry -->
