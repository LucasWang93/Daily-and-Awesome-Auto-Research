...
- [AI scientists produce results without reasoning scientifically](https://arxiv.org/abs/2604.18805v1): As AI systems increasingly take on autonomous roles in scientific research, understanding their reasoning processes is critical to ensure the reliability and self-correcting nature of scientific inquiry. Without proper epistemic reasoning, the knowledge produced by these systems risks being unjustified and potentially misleading, undermining the integrity of scientific advancements driven by AI agents.
- [HiRAS: A Hierarchical Multi-Agent Framework for Paper-to-Code Generation and Execution](https://arxiv.org/abs/2604.17745v1): HiRAS addresses critical challenges in automating computational research, enabling more accurate reproduction of experimental results from academic papers. By improving coordination among agents and refining evaluation metrics, it sets a new benchmark for AI-driven research automation, paving the way for faster and more reliable scientific advancements.
- [MedProbeBench: Systematic Benchmarking at Deep Evidence Integration for Expert-level Medical Guideline](https://arxiv.org/abs/2604.18418v1): MedProbeBench addresses a critical gap in evaluating AI systems for expert-level medical guideline development, a domain where precision, neutrality, and evidence-based reasoning are paramount. By setting a new standard for benchmarking, it pushes the boundaries of AI's ability to assist in high-stakes, real-world applications like healthcare decision-making.
...
<!-- BEGIN: latest-entry -->
[LiteResearcher: A Scalable Agentic RL Training Framework for Deep Research Agent](https://arxiv.org/abs/2604.17931v1) is the latest archived addition. Themes: End-to-End AI Scientists, Literature And Survey Agents. Why it matters: LiteResearcher addresses critical challenges in scaling reinforcement learning for research agents by creating a cost-effective and stable training environment. This innovation not only improves performance on key benchmarks but also democratizes access to advanced research capabilities, paving the way for more efficient and capable AI-driven scientific exploration.
<!-- END: latest-entry -->
