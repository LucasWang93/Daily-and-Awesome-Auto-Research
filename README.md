...
- [DataSTORM: Deep Research on Large-Scale Databases using Exploratory Data Analysis and Data Storytelling](https://arxiv.org/abs/2604.06474v1): DataSTORM bridges the gap between unstructured web data research and structured database analysis, enabling more robust and insightful data-centric investigations. Its ability to autonomously generate, validate, and narrate analytical theses has the potential to revolutionize fields reliant on large-scale structured data, from social sciences to business intelligence.
