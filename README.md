...
- **2026-03-30** [Marco DeepResearch: Unlocking Efficient Deep Research Agents via Verification-Centric Design](https://arxiv.org/abs/2603.28376v1) (End-to-End AI Scientists, Literature And Survey Agents) - card: [2603-28376v1-marco-deepresearch-unlocking-efficient-deep-research-agents-via-verification-centric-design.md](archive/papers/2026-04-01/2603-28376v1-marco-deepresearch-unlocking-efficient-deep-research-agents-via-verification-centric-design.md)
...
- **2026-03-30** [Autonomous Discovery of Particle Physics Theories from Experimental Data](https://arxiv.org/abs/2603.28935v1) (Autonomous Discovery) - card: [2603-28935v1-autonomous-discovery-of-particle-physics-theories-from-experimental-data.md](archive/papers/2026-04-01/2603-28935v1-autonomous-discovery-of-particle-physics-theories-from-experimental-data.md)
- **2026-03-30** [Towards a Medical AI Scientist](https://arxiv.org/abs/2603.28589v1) (End-to-End AI Scientists) - card: [2603-28589v1-towards-a-medical-ai-scientist.md](archive/papers/2026-04-01/2603-28589v1-towards-a-medical-ai-scientist.md)
<!-- END: recent-papers -->
...
- [MiroEval: Benchmarking Multimodal Deep Research Agents in Process and Outcome](https://arxiv.org/abs/2603.28407v1): As AI systems increasingly assist in complex research tasks, robust evaluation frameworks like MiroEval are essential to ensure these systems can meet real-world demands. By assessing both the research process and outcomes, MiroEval provides a comprehensive diagnostic tool that highlights strengths, weaknesses, and areas for improvement, paving the way for more reliable and capable AI research agents in diverse domains.
<!-- END: featured-papers -->

## Latest Archive Entry

<!-- BEGIN: latest-entry -->
[ASI-Evolve: AI Accelerates AI](https://arxiv.org/abs/2603.29640v1) is the latest archived addition. Themes: Autoresearch Loops. Why it matters: ASI-Evolve represents a significant leap in using AI to autonomously accelerate its own development, potentially reducing the time and cost of innovation in AI and other scientific fields. By automating complex research loops and achieving state-of-the-art results, it opens the door to a future where AI can independently drive progress in foundational technologies and beyond.
<!-- END: latest-entry -->
