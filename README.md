...
- **2026-05-13** [EvolveMem:Self-Evolving Memory Architecture via AutoResearch for LLM Agents](https://huggingface.co/papers/2605.13941) (Autoresearch Loops) - card: [2605-13941-evolvemem-self-evolving-memory-architecture-via-autoresearch-for-llm-agents.md](archive/papers/2026-05-15/2605-13941-evolvemem-self-evolving-memory-architecture-via-autoresearch-for-llm-agents.md)
...
- **2026-05-12** [AI CFD Scientist: Toward Open-Ended Computational Fluid Dynamics Discovery with Physics-Aware AI Agents](https://huggingface.co/papers/2605.06607) (End-to-End AI Scientists, Autonomous Discovery) - card: [2605-06607-ai-cfd-scientist-toward-open-ended-computational-fluid-dynamics-discovery-with-physics-aware-ai-agents.md](archive/papers/2026-05-15/2605-06607-ai-cfd-scientist-toward-open-ended-computational-fluid-dynamics-discovery-with-physics-aware-ai-agents.md)
...
- [Beyond AI as Assistants: Toward Autonomous Discovery in Cosmology](https://arxiv.org/abs/2605.14791v1): This research pushes the boundaries of AI from being mere tools to becoming autonomous agents capable of conducting scientific discovery. By applying these systems to cosmology, it not only advances our understanding of the universe but also sets the stage for AI to revolutionize how science is conducted across disciplines, tackling both structured and open-ended problems with minimal human intervention.
- [Agentic Design of Compositional Descriptors via Autoresearch for Materials Science Applications](https://arxiv.org/abs/2605.14671v1): This work showcases how AI-driven autoresearch can go beyond traditional tasks like model selection to autonomously design interpretable, task-specific features in materials science. By automating descriptor generation, it reduces reliance on manual feature engineering, accelerating discovery in complex scientific domains like materials property prediction.
- [EvolveMem:Self-Evolving Memory Architecture via AutoResearch for LLM Agents](https://arxiv.org/abs/2605.13941v1): EvolveMem represents a paradigm shift in how memory systems for LLM agents are designed and maintained, enabling them to autonomously improve their retrieval strategies over time. This innovation reduces the need for manual tuning, accelerates adaptability, and ensures more robust performance across diverse tasks and benchmarks, paving the way for more intelligent and self-sufficient AI systems.
- [EvolveMem:Self-Evolving Memory Architecture via AutoResearch for LLM Agents](https://huggingface.co/papers/2605.13941): EvolveMem represents a breakthrough in adaptive memory systems for large language models (LLMs), enabling them to autonomously refine their retrieval strategies and configurations over time. This innovation reduces the need for manual tuning, enhances long-term memory capabilities, and demonstrates transferable improvements across benchmarks, paving the way for more robust and intelligent LLM agents in real-world applications.
...
<!-- BEGIN: latest-entry -->
[Beyond AI as Assistants: Toward Autonomous Discovery in Cosmology](https://arxiv.org/abs/2605.14791v1) is the latest archived addition. Themes: End-to-End AI Scientists, Autonomous Discovery. Why it matters: This research pushes the boundaries of AI from being mere tools to becoming autonomous agents capable of conducting scientific discovery. By applying these systems to cosmology, it not only advances our understanding of the universe but also sets the stage for AI to revolutionize how science is conducted across disciplines, tackling both structured and open-ended problems with minimal human intervention.
<!-- END: latest-entry -->
