...
- **2026-04-14** [AgentSPEX: An Agent SPecification and EXecution Language](https://arxiv.org/abs/2604.13346v1) (Literature And Survey Agents) - card: [2604-13346v1-agentspex-an-agent-specification-and-execution-language.md](archive/papers/2026-04-16/2604-13346v1-agentspex-an-agent-specification-and-execution-language.md)
...
- [MERRIN: A Benchmark for Multimodal Evidence Retrieval and Reasoning in Noisy Web Environments](https://arxiv.org/abs/2604.13418v1): As AI systems increasingly assist in web-based research and decision-making, their ability to handle noisy, multimodal, and conflicting information is critical. MERRIN provides a rigorous testbed to push the boundaries of search-augmented AI agents, ensuring they can perform robust reasoning and retrieval in real-world scenarios where precision and efficiency are paramount.
- [MERRIN: A Benchmark for Multimodal Evidence Retrieval and Reasoning in Noisy Web Environments](https://huggingface.co/papers/2604.13418): As web environments grow increasingly complex and multimodal, AI agents must evolve to handle noisy, conflicting, and diverse sources effectively. MERRIN provides a critical testbed to evaluate and improve these capabilities, paving the way for more reliable and efficient search-augmented systems in real-world applications like research, education, and decision-making.
...
<!-- BEGIN: latest-entry -->
[TREX: Automating LLM Fine-tuning via Agent-Driven Tree-based Exploration](https://arxiv.org/abs/2604.14116v1) is the latest archived addition. Themes: End-to-End AI Scientists. Why it matters: TREX represents a significant step toward fully automating complex AI workflows, such as fine-tuning large language models. By leveraging multi-agent collaboration and tree-based exploration, it reduces the need for human intervention in iterative experimentation, making advanced AI research more accessible and scalable. This could accelerate innovation in AI applications across diverse domains, from healthcare to finance.
<!-- END: latest-entry -->
